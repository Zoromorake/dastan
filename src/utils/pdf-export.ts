...
import { normalizeDocumentLayout, renderLayoutTemplate } from './screenplay-layout';
...
function buildPrintableHtml(document: ScreenplayDocumentRecord): string {
	...
	const body = toPlainTextScreenplay(document.content)
		.split('\n')
...
<html>
  <head>
    ...
    <style>
      ...
      body { font-family: "Courier Prime", "Courier New", Courier, monospace; font-size: 12pt; line-height: 1; color: #111; }
      ...
      p { margin: 0 0 0.2rem; white-space: pre-wrap; }
    </style>
  </head>
  <body>
    ${titlePage}
