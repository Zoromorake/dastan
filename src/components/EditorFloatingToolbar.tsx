	...
	return (
		<div className="pointer-events-none fixed inset-x-0 bottom-6 z-40 flex justify-center px-4">
			<div className={`pointer-events-auto flex max-w-[calc(100vw-2rem)] items-stretch overflow-visible rounded-[1.35rem] border backdrop-blur-md ${floatingBarClass}`}>
				<ToolbarButton className={floatingBtnClass} title="Undo" ariaLabel="Undo" onClick={onUndo}>
					<Undo2 size={20} strokeWidth={2.2} />
				</ToolbarButton>
				<ToolbarButton className={floatingBtnClass} title="Redo" ariaLabel="Redo" onClick={onRedo}>
