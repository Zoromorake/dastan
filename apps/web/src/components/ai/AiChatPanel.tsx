...
export function AiChatPanel({
	...
	const panelClass = isDark
		? 'fixed inset-x-0 top-28 bottom-0 z-50 flex w-full flex-col overflow-hidden border-t border-slate-700 bg-slate-800 shadow-[0_-20px_60px_rgba(0,0,0,0.35)] sm:inset-x-auto sm:right-0 sm:w-[24rem] sm:border-l sm:border-t-0 sm:shadow-[-20px_0_60px_rgba(0,0,0,0.35)]'
		: 'fixed inset-x-0 top-28 bottom-0 z-50 flex w-full flex-col overflow-hidden border-t border-stone-300 bg-[#f6f2ea] shadow-[0_-20px_60px_rgba(28,25,23,0.12)] sm:inset-x-auto sm:right-0 sm:w-[24rem] sm:border-l sm:border-t-0 sm:shadow-[-20px_0_60px_rgba(28,25,23,0.12)]';
